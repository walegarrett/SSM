...
<%--    <a href="employee/findAll">点击测试查询所有的部门信息</a>--%>
    ...
    <script>
            ...
            $.ajax({
                ...
                success:function (result) {
                    ...
                    $.each(result.extend.depts,function () {
                        //alert(this.deptId+" "+this.deptName);
        ...
        function validate_add_form(){
            ...
            if(!regName.test(empName)){
                //alert("用户名可以是2-5位中文或者6-16位引文和数字的组合");
                show_validate_msg("#empName_add_input","error","用户名可以是2-5位中文或者6-16位引文和数字的组合");
                return false;
            }else{
        ...
        $(document).on("click",".edit_btn",function () {
            ...
            //1.查出员工信息，并且显示
            getEmp($(this).attr("edit-id"));//拿到编辑按钮的属性值即员工id
        ...
        $("#emp_update_btn").click(function () {
            ...
            //发送ajax请求，保存更新的用户信息
            $.ajax({
                url:"${APP_PATH}/employee/emp/"+$(this).attr("edit-id"),
                method:"PUT",//"POST
        ...
        $(document).on("click",".delete_btn",function () {
            ...
            if(confirm("确认删除【"+empName+"】吗？")){
                //确认，发送ajax请求删除
                $.ajax({
                    url:"${APP_PATH}/employee/emp/"+empId,
                    type:"DELETE",
                    success:function (result) {
                        //alert(result.msg);
                        to_page(currentPage);
